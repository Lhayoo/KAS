<nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
    ...
    <div class="layout-menu-toggle navbar-nav align-items-xl-center me-3 me-xl-0 d-xl-none">
        <a class="nav-item nav-link px-0 me-xl-4" href="<?= BASE_URL . 'accoutSettings' ?>">
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="#" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <img src="<?= BASE_URL ?>assets/img/profile/<?= $data['info']['profile'] ?>"
                            class="w-px-40 h-auto rounded-circle" />
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <a class="dropdown-item" href="<?php BASE_URL . 'accoutSettings' ?>">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <span class="fw-semibold d-block"><?= $data['info']['nama'] ?></span>
                                    <small class="text-muted"><?= $data['info']['role'] ?></small>
                                </div>
                            </div>
                        </a>
                    </li>
