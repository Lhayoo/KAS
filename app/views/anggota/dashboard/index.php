            ...
            <div class="card-header p-3 pt-2">
                <div class="card-title d-flex align-items-start justify-content-between">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                            <a class="dropdown-item" href="<?= BASE_URL . 'dataKas' ?>">View More</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-header p-3 pt-2">
                <div class="card-title d-flex align-items-start justify-content-between">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                            <a class="dropdown-item" href="<?= BASE_URL . 'pemasukan' ?>">View More</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-header p-3 pt-2">
                <div class="card-title d-flex align-items-start justify-content-between">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                            <a class="dropdown-item" href="<?= BASE_URL . 'pengeluaran' ?>">View More</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                        <div class="chart">
                            <div class="row row-bordered g-0 ">
                                <div class="col-lg-12">
                                    <h5 class="card-header m-0 me-2 pb-3">Data kas yang belum dibayar
                                    </h5>
